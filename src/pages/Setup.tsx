...
const Setup = () => {
  ...
  const handleDefaultSetup = () => {
    const defaultStartingTiles: TileRow[] = [
      { id: 1, word: 'BATAGOR', tag1: 'BANDUNG', tag2: 'KULINER', tag3: 'WISATA' },
      { id: 2, word: 'KOTA TUA', tag1: 'JAKARTA', tag2: 'TEMPAT', tag3: 'WISATA' },
    ];

    const defaultReserveTiles: TileRow[] = [
      { id: 3, word: 'GADO-GADO', tag1: 'JAKARTA', tag2: 'KULINER', tag3: 'WISATA' },
      { id: 4, word: 'GARUDA WISNU KENCANA', tag1: 'BALI', tag2: 'BANGUNAN', tag3: 'WISATA' },
      { id: 5, word: 'ANGKLUNG', tag1: 'BANDUNG', tag2: 'KERAJINAN', tag3: 'WISATA' },
      { id: 6, word: 'MALIOBORO', tag1: 'JOGJA', tag2: 'TEMPAT', tag3: 'WISATA' },
      { id: 7, word: 'MONAS', tag1: 'JAKARTA', tag2: 'BANGUNAN', tag3: 'WISATA' },
      { id: 8, word: 'SATE LILIT', tag1: 'BALI', tag2: 'KULINER', tag3: 'WISATA' },
      { id: 9, word: 'KAWAH PUTIH', tag1: 'BANDUNG', tag2: 'TEMPAT', tag3: 'WISATA' },
      { id: 10, word: 'BATIK', tag1: 'JOGJA', tag2: 'KERAJINAN', tag3: 'WISATA' },
      { id: 11, word: 'SONGKET', tag1: 'BALI', tag2: 'KERAJINAN', tag3: 'WISATA' },
      { id: 12, word: 'KERATON', tag1: 'JOGJA', tag2: 'BANGUNAN', tag3: 'WISATA' },
      { id: 13, word: 'WHOOSH', tag1: 'JAKARTA', tag2: 'BANDUNG', tag3: 'WISATA' },
      { id: 14, word: 'PAWAI ADAT', tag1: 'JOGJA', tag2: 'BALI', tag3: 'WISATA' },
    ];
